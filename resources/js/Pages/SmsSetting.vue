  ...
  <div class="flex flex-col justify-between mx-auto max-w-7xl py-10 px-4">
    ...
    <div class="border border-light w-full rounded-md shadow-xl">
      <div class="p-4 border-b-2">
        <h1 class="text-2xl uppercase font-extrabold text-secondary">Billing</h1>
      </div>
      <div class="p-4 grid w-full sm:w-1/2 space-y-4">
        <div class="">
          <label for="message" class="uppercase text-xs font-bold text-primary mb-2 block">Fields</label>
          <div>
            <span>cust_name</span>
            <span>account_no</span>
            <span>account_code</span>
            <span>bill_balance</span>
          </div>
        </div>
        <div class="">
          <label for="message" class="uppercase text-xs font-bold text-primary mb-2 block">Message</label>
          <textarea v-model="messageTemplate" placeholder="Compose your message here..."
            class="border-2 border-light rounded-md p-2 outline-primary text-xs w-full"></textarea>
        </div>
        <!-- <p class="text-accent font-semibold text-sm my-5">Please enter your APP credentials to enable SMS functionality.
        </p> -->
